...
func setUpLevel() {
	{
		...
		//Declare neighbors
		{
			...
			nodes[131].neighbors = append(nodes[131].neighbors, nodes[130], nodes[132])
			nodes[132].neighbors = append(nodes[132].neighbors, nodes[131], nodes[133])
			nodes[133].neighbors = append(nodes[133].neighbors, nodes[132], nodes[134], nodes[143])
